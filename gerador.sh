...
tittle() {
    ...
    clear && clear
    msg -bar
    cat <(curl -sSL https://gist.githubusercontent.com/drowkid01/2f170383af1420699c66a6a94b786b6d/raw/1e378065d6ab51024cb4c0c6d8046ae42176ab73/.banner)
}
...
[[ ! -e ${SCPT_DIR} ]] && bash /bin/dksources/echo-ram.sh
DIR="/etc/http-shell"
LIST="$(echo "qwerty+"| rev)"
#wget -O /bin/dksources/v-new.log https://raw.githubusercontent.com/NetVPS/Multi-Script/main/ChuGH-5.7u/adm-lite/v-local.log &>/dev/null
v1=$(cat <(curl -sSL https://raw.githubusercontent.com/ChumoGH/ScriptCGH/main/GERADOR/v-new.log))
v2=$(cat <(curl -sSL https://raw.githubusercontent.com/ChumoGH/ScriptCGH/main/GERADOR/v-new.log))
txt[315]=" 🚀 ⚡ \033[1;34mＤ\033[1;32mｒ\033[1;30mｏ\033[1;31mｗ\033[1;35mＫ\033[1;36mＧ\033[1;31mｅ\033[1;33mｎ\033[0m ⚡ 🚀 "
txt[316]=" 🚀 ⚡ \033[1;34mＤ\033[1;32mｒ\033[1;30mｏ\033[1;31mｗ\033[1;35mＫ\033[1;36mＧ\033[1;31mｅ\033[1;33mｎ\033[0m ⚡ 🚀 "
...
echo  #' >/bin/genon
            ...
            crontab /root/cron
            rm /root/cron
            sed '/genon/ d' /etc/crontab >/bin/dksources/crontab
            cat /bin/dksources/crontab >/etc/crontab
            service cron restart
...
act_gen() {
    ...
    #source <(curl -sL https://raw.githubusercontent.com/drowkid01/ChumoGH-Script/master/Key-gerar/insta.sh)
}
